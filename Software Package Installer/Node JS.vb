...
Public Class Node_JS
    ...
    Private Sub Node_JS_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_58ff61939b734254a8bf4e462c41ba19.zip"), Texbbb.TextBox72.Text)
