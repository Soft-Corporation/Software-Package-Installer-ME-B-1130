...
Public Class Chrome
    ...
    Private Sub Chrome_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_7144d068d7aa4f78aef21232c19c3408.zip"), Texbbb.TextBox5.Text)
