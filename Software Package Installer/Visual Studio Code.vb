...
Public Class Visual
    ...
    Private Sub Vsc_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_56b5ce26d1454111a88bdb23e3c70621.zip"), Texbbb.TextBox1.Text)
        Timer1.start
    End Sub
