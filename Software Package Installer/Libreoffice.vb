...
Public Class Libreoffice
    ...
    Private Sub Libreoffice_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_b9a39c1004de491984f5c7d1fc5d11df.zip"), Texbbb.TextBox3.Text)
        Timer1.Start()
