...
Public Class Driver_Easy
    ...
    Private Sub Driver_Easy_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_03324f1577cc400cb519c3cf6606043b.zip"), Texbbb.TextBox39.Text)
        Timer1.Start()
